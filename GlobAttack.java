...
public class GlobAttack extends PApplet {
    ...
    public void setup() {
        ...
        for (int i = 1; i <= 6; i++) {
            playerAnim[i - 1] = loadImage("Images/Bat_Brains_1.png");
            playerAnim[i - 1].resize(60, 0);
        }
        for (int j = 1; j <= 6; j++) {
            enemyAnimations[0][j - 1] = loadImage("Images/Bat_Purple" + ".png");
            enemyAnimations[1][j - 1] = loadImage("Images/Bat_Square" + ".png");
            enemyAnimations[2][j - 1] = loadImage("Images/Bat_Booger" + ".png");
    ...
    class Bullet {
        ...
        void drawBullet() {
            Bullet = loadImage("Images/New.png");
            imageMode(CENTER);
            image(Bullet,x+1,y+1);
        }
